...
class QwenFacadeAnalyzer:
    ...
    def __init__(self, model_size: str = "7b"):
        ...
        Args:
            model_size: "7b" or "2b" (smaller model for limited VRAM)
        """
...
def get_facade_analyzer(model_size: str = "7b") -> QwenFacadeAnalyzer:
    """Get or create facade analyzer instance
    
    Args:
        model_size: "7b" (default) or "2b" (smaller)
    ...
    if _analyzer_instance is None:
        _analyzer_instance = QwenFacadeAnalyzer(model_size=model_size)
