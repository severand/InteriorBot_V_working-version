...
# 3️⃣ ПРОГРЕСС - Отправляем сообщение с прогрессом "⚡ Генерирую modern дизайн..."
...
async def style_choice_handler(callback: CallbackQuery, state: FSMContext, admins: list[int], bot_token: str):
    ...
    4️⃣ УДАЛЕНИЕ ТЕКСТОВОГО МЕНЮ
       - callback.message.delete() → удаляем меню со стилями
    ...
    # ═══════════════════════════════════════════════════════════════════════════════════════════════════
    # 4️⃣ УДАЛЕНИЕ ТЕКСТОВОГО МЕНЮ СО СТИЛЯМИ
    # ═══════════════════════════════════════════════════════════════════════════════════════════════════
    ...
    # ═══════════════════════════════════════════════════════════════════════════════════════════════════
    # 5️⃣ ОТПРАВКА СООБЩЕНИЯ С ПРОГРЕССОМ
    # ═══════════════════════════════════════════════════════════════════════════════════════════════════
    ...
    # ═══════════════════════════════════════════════════════════════════════════════════════════════════
    # 6️⃣ 🤖 ГЕНЕРАЦИЯ ДИЗАЙНА [ГЛАВНАЯ ОПЕРАЦИЯ]
    # ═══════════════════════════════════════════════════════════════════════════════════════════════════
    ...
    # ═══════════════════════════════════════════════════════════════════════════════════════════════════
    # 7️⃣ ОБРАБОТКА УСПЕШНОЙ ГЕНЕРАЦИИ
    # ═══════════════════════════════════════════════════════════════════════════════════════════════════
...
📊 Баланс: <b>{balance}</b> генераций | 🔧 Режим: <b>{work_mode}</b>"""
        ...
        try:
            ...
            # 7️⃣ ОТПРАВЛЯЕМ ДИЗАЙН (сообщение 1)
            ...
            # ═════════════════════════════════════════════════════════════════════════════════════════
            # 8️⃣ ОТПРАВЛЯЕМ МЕНЮ С КНОПКАМИ (сообщение 2)
            # ═════════════════════════════════════════════════════════════════════════════════════════
            ...
            # ═════════════════════════════════════════════════════════════════════════════════════════
            # 9️⃣ ОЧИСТКА ИНТЕРФЕЙСА - Удаляем сообщение с прогрессом
            # ═════════════════════════════════════════════════════════════════════════════════════════
        ...
        # ═════════════════════════════════════════════════════════════════════════════════════════════
        # 1️⃣0️⃣ ПЕРЕХОД НА SCREEN 6 - Устанавливаем состояние POST_GENERATION
        # ═════════════════════════════════════════════════════════════════════════════════════════════
