...
PHASE 3 TASK 8: ПЕРЕНАИМЕНОВАН router → pro_mode_router (2025-12-24 20:11)
...
[2026-01-05 15:22] 🔥 CRITICAL FIX MARKDOWN IN SELECT_PRO_MODE:
- Fixed text in select_pro_mode() that had unclosed markdown tags
- Removed **, [ ], and other special markdown characters from plain text
- Added proper add_balance_and_mode_to_text() call with work_mode parameter
- Standardized all footer calls across all handlers
"""
...
Текущие параметры: {current_ratio} @ {current_resolution}"""
        ...
        # 🔥 [2026-01-05] FIX: Add balance and mode to text BEFORE edit_menu()
        text = await add_balance_and_mode_to_text(text, user_id, work_mode='profile_settings')
